#!/usr/bin/env bash
# Generated by build.sh on Thu Sep 11 02:13:49 PM MDT 2025
# Auto-assembled from numbered modules: 01_config.sh 02_colors.sh 03_printers.sh 04_options.sh 05_guards.sh 06_git-ops.sh 07_version.sh 08_detect.sh 09_resolve.sh 10_getset.sh 11_semver.sh 12_lifecycle.sh 13_commands.sh 14_hooks.sh 15_dispatch.sh
# === 01_config.sh ===
#!/usr/bin/env bash
#
...
print_version() {
    ...
    if [[ "$show_note" -eq 0 ]]; then
        ...
        printf "%sCopyright (C) 2016-2025, Qodeninja %s\n"  "$grey"  "$x" >&2;
